...
class PaymentInfoActivity : AppCompatActivity(), View.OnClickListener, Observer<RestObservable> {
    ...
    var profile = java.util.ArrayList<com.elewamathtutoring.Models.Teacher_details.Body>()
    var selectedprice=0
    var finalvalue=""
    var perHour=""
    var value=0
  ...
  var typescreen=""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      try
      {
        profile = ((intent.getSerializableExtra("teacher_detail") as java.util.ArrayList<com.elewamathtutoring.Models.Teacher_details.Body>?)!!)
            ...
            Status.SUCCESS -> {
                if (liveData.data is CardListingResponse) {
                  ...
                  else
                  {
                    ...
                    edPromoCode.text="We've let "+profile.get(0).name+" know that you are interested.Once they have confirmed your session, your card on file will be debited for $"+selectedprice+".00."
    ...
    fun booking(cardid: String)
    {
       ...
       var count=0
        ...
        try {
            val words2: java.util.ArrayList<String> = selectedpric.split(",") as java.util.ArrayList<String>
//--20,10,20=hour=10,10,10=time=1-2,5,7-8cardid70
            for(i in 0 until words2.size)
            {
                ...
                try
                {
                    val aftersplit: java.util.ArrayList<String> = words2.get(i).split("-") as java.util.ArrayList<String>
        ...
        }catch (e:Exception)
        {
            ...
            try {
                // 5-6-7
                val aftersplit: java.util.ArrayList<String> = selectedpric.split("-") as java.util.ArrayList<String>
                for(ii in 0 until aftersplit.size)
                {
                    value=value+aftersplit.get(ii).toInt()
                    count++
