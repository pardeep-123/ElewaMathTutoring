...
class ScheduleASessionActivity : AppCompatActivity(), View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        teacherdetails = ((intent.getSerializableExtra("teacher_detail") as ArrayList<RequestDetailResponse.Body>?)!!)
    ...
    private fun setChooseTimeAdapter() {
        rv_chooseTime.adapter = ChooseTimeAdapter(this, teacherdetails)
    }
