...
class Viewall_trangection : AppCompatActivity() {
    var list=ArrayList<com.elewamathtutoring.Models.Wallet.Body>()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list = (intent.getSerializableExtra("listof_trangection") as java.util.ArrayList<com.elewamathtutoring.Models.Wallet.Body>?)!!
